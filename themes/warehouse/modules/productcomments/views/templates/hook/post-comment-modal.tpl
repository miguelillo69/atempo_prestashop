  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <span class="modal-title">{l s='Write your review' d='Modules.Productcomments.Shop'}</span>
        ...
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          ...
          <div class="row form-group ">
            ...
            <div class="col-md-6 col-sm-6 post-comment-buttons">
              <button type="button" class="btn btn-secondary btn-comment-inverse btn-comment-big" data-dismiss="modal" aria-label="{l s='Cancel' d='Modules.Productcomments.Shop'}">
