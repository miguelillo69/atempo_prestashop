...
{block name="input"}
    ...
    <div class="col-lg-9">
        ...
        {else}
        <a href="{$field['url']|escape:'html':'UTF-8'}" class="m-b-2 m-r-1 btn pointer btn-connect-with-instagram"><i class="icon-instagram"></i> {l s='Connect with your Instagram' mod='iqitelementor'}</a>
        {/if}
        </div>
    </div>
