...
class RevSliderAdmin extends UniteBaseAdminClassRev {
    ...
    public function __construct($param=null,$init=false) {
        ...
        RevSliderGlobals::$urlCaptionsCSS = RS_PLUGIN_PATH."/public/assets/css/captions.php";
        ...
        RevSliderGlobals::$uploadsUrlExportZip = RS_PLUGIN_PATH. '/uploads/export.zip';
    ...
    public static function assignTableNames(){
        self::$table_prefix = _DB_PREFIX_;
        RevSliderGlobals::$table_sliders = self::$table_prefix . RevSliderGlobals::TABLE_SLIDERS_NAME;
        RevSliderGlobals::$table_slides = self::$table_prefix . RevSliderGlobals::TABLE_SLIDES_NAME;
        RevSliderGlobals::$table_static_slides = self::$table_prefix . RevSliderGlobals::TABLE_STATIC_SLIDES_NAME;
        RevSliderGlobals::$table_settings = self::$table_prefix . RevSliderGlobals::TABLE_SETTINGS_NAME;
...
//        $RevSliderOperations->moveOldCaptionsCss();
        ...
        self::addCommonInit();
        rev_head();
        RevSliderBaseAdmin::setMasterView('master-view');
        RevSliderBaseAdmin::requireView(RevSliderBaseAdmin::$view);
        rev_footer();
    }
    
    public static function addCommonInit(){
         $wpColorPickerL10n = array(
                ...
                $filemanager_url =  RevLoader::getConstants("url_filemanager_actions");
    ...
    public static function customPostFieldsOutput(UniteSettingsProductSidebarRev $output) {
       ...
       //     self::insertValues();
		...
		//wp_enqueue_style(array('wp-jquery-ui', 'wp-jquery-ui-core', 'wp-jquery-ui-dialog', 'wp-color-picker'));
               ...
               // $wpColorPickerL10n = '{"clear":"Clear","defaultString":"Default","pick":"Select Color","current":"Current Color"}';
                $wpColorPickerL10n = array(
                    "clear"=>"Clear",
                    "defaultString"=>"Default",
                    "pick"=>"Select Color",
                ...
                wp_localize_script('wpColorPickerL10n', 'wpColorPickerL10n', $wpColorPickerL10n); //Load multilanguage for JavaScript
                 ...
                 $filemanager_url = rev_site_admin_url()."?route=extension/module/fmanager&token=".sds_get_oc_token();
                 wp_localize_script('uploadurl', 'uploadurl', $filemanager_url); //Load multilanguage for JavaScript

                 wp_enqueue_script('core_js', RS_PLUGIN_URL .'admin/assets/js/jquery/core.min.js', array(), RevSliderGlobals::SLIDER_REVISION );
              //   wp_enqueue_script('color_js', RS_PLUGIN_URL .'admin/assets/js/jquery/jquery.color.min.js', array(), RevSliderGlobals::SLIDER_REVISION );
            //   wp_enqueue_script('colorpicker_js', RS_PLUGIN_URL .'admin/assets/js/colorpicker.js', array(), RevSliderGlobals::SLIDER_REVISION );
...
//               wp_enqueue_style('codemirror_css', RS_PLUGIN_URL .'admin/assets/css/codemirror.css', array(), RevSliderGlobals::SLIDER_REVISION);
//		
...
//
//                    //    var_dump(self::$view);var_dump(self::VIEW_SLIDERS);die();
//
...
//			
			...
			switch($action){
				...
				//	$viewBack = self::getViewUrl(self::VIEW_SLIDERS);
                                        $viewBack = RevLoader::getConstants('browse_sliders');
					$updateAnim = self::getPostGetVar("update_animations");
					$updateNav = self::getPostGetVar("update_navigations");
					//$updateStatic = self::getPostGetVar("update_static_captions");
					$updateStatic = 'none';
