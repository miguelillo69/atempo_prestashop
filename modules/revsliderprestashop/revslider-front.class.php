...
class RevSliderFront extends RevSliderBaseFront{
	...
	//	add_filter('punchfonts_modify_url', array('RevSliderFront', 'modify_punch_url'));
        ...
        public static function rev_head_front(){
          //  var_dump(RevLoader::$front_scripts);die();
	...
	public static function rev_foot_front(){
            $allLocalScripts = "<script type='text/javascript'>";
             foreach(RevSliderBase::$local_scripts_footer as $var_name => $scripts_each){ 
            ...
            foreach(RevLoader::$front_scripts_foot as $script){
                  echo "<script type='text/javascript' src='{$script}'></script>";
            }
        }
	/**
